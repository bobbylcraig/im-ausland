...
<p>Of course, a large part of this log was also the creative and technical side. I've had a lot of fun developing it. I'd be remiss if I didn't mention the inspiration though. The inspiration for this blog was derived from <a href="https://tympanus.net/Development/StorytellingMap/">this storytelling map</a>. I took a lot from this concept and figured I'd give credit where credit is due. The execution in terms of code is rather different (he used Node.js for everything...I figured I had to host it on GitHub pages...so Node was a no-go), and I personally don't think my design is as great, but I tried and am actually pretty happy with the result.</p>
